---
title: "实验说明"
description: "用 Linux namespaces 与 bubblewrap 做的真实可跑沙箱实验。"
---
...
常用参数在 [`sandbox_run.py`](https://github.com/wurenrumian/agent-sandbox/blob/main/agent-sandbox-lab/sandbox_run.py) 顶部的 `BWRAP` 列表里，可自行增删：
...
详见教程 [附录 C：安全检查清单](/agent-sandbox/guide/appendix-c-security-checklist/)。
...
- [教程第 9 章：实战搭建](/agent-sandbox/guide/09-hands-on/)
- [实测输出记录 RESULTS.md](/agent-sandbox/lab/results/)
- [MCP 配套代码](/agent-sandbox/lab/code/)
