...
- 教程（多文件版）：[`agent-sandbox-tutorial/`](agent-sandbox-tutorial/README.md)
- 可运行实验（bwrap + MCP 示例）：[`agent-sandbox-lab/`](agent-sandbox-lab/README.md)
